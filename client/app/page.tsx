  ...
  const features = [
    {
      ...
      title: "Fast Results",
      description:
        "See improvements in your credit score within 30-60 days with our proven strategies.",
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Professional credit restoration service that removes negative
                items and rebuilds your financial future. Join thousands who've
                improved their credit with our proven system.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our proven system has helped thousands of clients improve their
      ...
      <section id="services" className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our comprehensive credit repair service targets all types of
              negative items that may be hurting your credit score.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              See how we've helped real clients transform their credit
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of satisfied clients and start your credit repair
            journey today. See results in as little as 30 days with our proven
            system.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400">
                Professional credit restoration service helping you achieve
                financial freedom.
              </p>
            </div>
            <div>
