...
export default function AgentDashboard() {
    ...
    try {
      ...
      socket.on("user_typing", (data) => {
        if (
          data.userType === "user" &&
          selectedChat &&
          selectedChat.chatId === data.chatId
        ) {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 flex items-center justify-center text-white">
        Loading...
      </div>
    );
  }
          ...
          {selectedChat ? (
                    ...
                    <div>
                      ...
                      {selectedChat.selectedPlan && (
                        <p className="text-gray-400 text-xs">
                          Plan: {selectedChat.selectedPlan.title}
                        </p>
                      )}
                    </div>
                  </div>
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center text-gray-400">
                ...
                <p>
                  Choose a conversation from the sidebar to begin chatting with
                  customers
                </p>
              </div>
            </div>
