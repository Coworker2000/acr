(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_4a6ffe6c._.js", {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            const initializeChat = {
                "ChatPage.useEffect.initializeChat": async ()=>{
                    ...
                    socket.on('connect', {
                        "ChatPage.useEffect.initializeChat": ()=>{
                            setIsConnected(true);
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            setMessages(chat.messages.map({
                                "ChatPage.useEffect.initializeChat": (msg)=>({
                                        ...msg,
                    ...
                    socket.on('receive_message', {
                        "ChatPage.useEffect.initializeChat": (message)=>{
                            setMessages({
                                "ChatPage.useEffect.initializeChat": (prev)=>[
                                        ...prev,
                                        {
                                            ...message,
                    ...
                    socket.on('user_typing', {
                        "ChatPage.useEffect.initializeChat": (data)=>{
...
_s(ChatPage, "HXjM7/dBRozU16RtSADMfTSsiQA=", false, function() {
    return [
...
//# sourceMappingURL=_4a6ffe6c._.js.map